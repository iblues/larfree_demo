    ...
    */
    ...
    'disks' => [
        ...
        'oss' => [
            ...
            'endpoint' => env('ALI_END_POINT', ''), // OSS 外网节点或自定义外部域名
            ...
            'ssl' => env('ALI_OSS_HTTPS', 'false'), // true to use 'https://' and false to use 'http://'. default is false,
            'isCName' => env('ALI_OSS_CDN_DOMAIN', '') ? true : false, // 是否使用自定义域名,true: 则Storage.url()会使用自定义的cdn或域名生成文件url， false: 则使用外部节点生成url
